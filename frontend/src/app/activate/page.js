...
import { ShieldCheck, Mail, Loader2, ArrowLeft, ChevronRight, UserPlus } from 'lucide-react';
        ...
        <div className="bg-white border border-slate-200 rounded-3xl md:rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-slate-200 relative overflow-hidden">
          ...
          <div className="text-center mb-8 md:mb-10">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight mb-2">
              Aktivasi <span className="text-primary">Akun</span>
            </h1>
            <p className="text-sm md:text-base text-slate-500 font-medium leading-relaxed">
              Masukkan email atau nomor telepon yang terdaftar pada pengurus RT untuk mendapatkan kode aktivasi.
            </p>
          </div>
