    ...
    <div className="space-y-6 md:space-y-10 animate-fade-in relative pb-20 font-sans max-w-5xl mx-auto px-4 sm:px-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-8 border-b border-slate-200 pb-6 md:pb-10">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 text-sm md:text-lg font-medium">Bayar iuran bulanan dengan mudah dan cepat.</p>
        </div>
      ...
      {selectedIds.length > 0 && (
        <div className="fixed bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-2xl animate-in slide-in-from-bottom-10 duration-500">
        ...
        <div className="grid grid-cols-1 gap-4 md:gap-6">
          {tagihan.map((item) => (
            <div 
              ...
              className={`bg-white p-5 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border-2 flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-8 group transition-all cursor-pointer ${
            ...
            >
              <div className="flex items-center gap-4 md:gap-6">
                ...
                <div className={`w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-[1.2rem] flex items-center justify-center shadow-md transition-transform group-hover:scale-110 shrink-0 ${
